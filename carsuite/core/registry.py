...
# ==============================================================================
"""Registry is central source of truth in `carsuite` (borrowed from
Habitat)."""
...
from carsuite.core.typing import Singleton


class Registry(metaclass=Singleton):
  """The `carsuite` singleton registry object definition."""
...
# Initializes the singleton registry for `carsuite`.
registry = Registry()
